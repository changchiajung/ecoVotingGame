...
class VotingPage(Page):
    ...
    def vars_for_template(self):
        ...
        self.player.origin_option = int(self.group.origin_division.split(",")[Constants.players_per_group - rank])
        self.player.alternative_option = int(self.group.alternative_division.split(",")[Constants.players_per_group - rank])
